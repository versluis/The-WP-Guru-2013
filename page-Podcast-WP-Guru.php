 ...
 * @since Twenty Thirteen 1.0
  ...
  Template Name: Podcast Feed - WP Guru
...
$text = "<br><h3>Subscribe on iTunes for all current and future epidoes:</h3><a href='https://itunes.apple.com/us/podcast/screencast-the-wp-guru/id604088441' target='_blank'><img id='apple-badge' src='".$badge . "'></a>";
echo $text;
// end of Apple Badge
