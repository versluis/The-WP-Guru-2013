			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="entry-content">
						...
						$howManyComments = 30;
						echo "<p>There are a total of <strong>$comments->total_comments</strong> comments on this site.<br>Below are the most recent $howManyComments of them, newest at the top.</p>";
